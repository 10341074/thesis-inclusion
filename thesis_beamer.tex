...
% \linespread{0.9}
%---
\node (t1) []  at (2.6,5.8){\color{purple} Let ${\color{blue}z}$ be the {\color{blue}sampling point}};
...
\node (n4) [MN_large=purple/purple1, minimum width=7cm
            ]  at (4,4){\color{purple} Tikhonov regularization \\ $Kx = y_z$};
...
\node (t1) []  at (1.65,2.7){\footnotesize Numerical results};
