...
the regularization parameter $\alpha$. We see that for small and sharp shapes, 
we need to be more accurate with smaller values for $\alpha$. Furthermore
the vicinity of the observation boundary doesn't affect the reconstruction in a relevant
way, as in other methods.
\par
...
\input{thesis_notes/fig_one_ellipse}
...
\input{thesis_notes/fig_one_shape}
