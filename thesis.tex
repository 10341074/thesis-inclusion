...
Instead, in Figure \ref{fig:contourplots_direct} we can compare the direct implementation of two 
direct maps the Laplace problem and the inclusion problem.
\iftoggle{fig}{
\begin{center}
\begin{figure}
...
\caption{Numerical discretization of the direct problems, with Neumann boundary data given by the 
harmonic function $(x-2)^2-y^2$.}
...
\subfloat[][\emph{Factorization method}.]
{
\includegraphics[width=.38\textwidth]{fig/first_compare_fm_drop0}
}
