...
{\parindent0pt
Grazie papà e mamma, per esserci ed avermi sostenuto;

grazie Irene, Stefano, Filippo;

grazie a chi in questi anni mi ha visto poco e mi ha pensato tanto;

grazie professor. Di Cristo, per aver creduto in me, per averlo fatto in modo sincero, ed avermi insegnato molto;

grazie professor. Micheletti per i preziosi consigli;
...
\label{fig:first_compare_twothre_eellipse_eig}
\end{figure}
\end{center}
